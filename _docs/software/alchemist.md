...
- [User Guide](/docs/software/alchemist/alchemist-usage)
- [Buttons & Shortcuts](/docs/software/alchemist/alchemist-buttons-and-shortcuts)
- [Download](/docs/software/alchemist/alchemist-download)

---

## Preview

![Alchemist UI](/assets/img/software/alchemist/alchemist-main.png)