...
<table>
  <tr>
    <td width="50%"><img src="/assets/img/mapping/zones/radiant_start_zone.png" alt="Top or main view"></td>
    <td width="50%"><img src="/assets/img/mapping/zones/radiant_start_zone_kvps.png" alt="Properties panel view"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="60%"><img src="/assets/img/mapping/zones/radiant_split_zones.png" alt="Main view"></td>
    <td width="40%">
      <img src="/assets/img/mapping/zones/radiant_zone_2a_kvps.png" alt="Properties view A"><br>
      <img src="/assets/img/mapping/zones/radiant_zone_2b_kvps.png" alt="Properties view B">
    </td>
  </tr>
</table>
...
[Player Respawn Point Prefab](/assets/files/mapping/zones/respawn_points.rar)
...
<table>
  <tr>
    <td width="60%"><img src="/assets/img/mapping/zones/player_respawn_point_setup.png" alt="Main view"></td>
    <td width="40%">
      <img src="/assets/img/mapping/zones/radiant_zone_player_respawn.png" alt="Properties view A"><br>
      <img src="/assets/img/mapping/zones/radiant_zone_player_respawn_kvps.png" alt="Properties view B">
    </td>
  </tr>
</table>
...
[Example Map](/assets/files/mapping/zones/zm_zone_test.map)
